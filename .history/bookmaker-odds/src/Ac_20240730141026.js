...
const Ac = () => {
  ...
  return (
    <!DOCTYPE html>
<!-- This site was created in Webflow. https://webflow.com --><!-- Last Published: Tue Jul 30 2024 12:08:01 GMT+0000 (Coordinated Universal Time) -->
<html
...
>
  <head>
    ...
    <link
      href="https://cdn.prod.website-files.com/66a798c7ac0b5daec1a87a18/css/lukas-dapper-site-ff64cc.webflow.bacb6edae.css"
      rel="stylesheet"
      type="text/css"
    />
          ...
          >
            ...
            >
              ...
              >
                <div class="div-block-4">
                  <label for="message" class="field-label-2"
                    ><strong>Total Stake:</strong></label
                  >
                </div>
                <div class="div-block-7">
                  <input
              ...
              >
                <div class="div-block-4">
                  <label for="message" class="field-label-2"
                    ><strong>Total Payout:</strong></label
                  >
                </div>
                <div class="div-block-7">
                  <input
