              ...
              <div class="navbar-wrapper">
                ...
                <nav role="navigation" class="nav-menu-wrapper w-nav-menu">
                  ...
                  <div class="nav-menu-cta">
                    <Link to="/dashboard" class="button muted w-button">
                      Log in
                    </Link>
          ...
          <div class="pricing-hero-section" name="pricing">
            <div class="container">
              ...
              <div class="pricing-hero-container">
                <Link to="/dashboard" class="pricing-hero-card w-inline-block">
                ...
                <Link
                  to="/dashboard"
                  class="pricing-hero-popular-card w-inline-block"
                >
              ...
              >
                ...
                >
                  <div class="faq-question">
                    <div class="faq-question-text">What is Zenden?</div>
                    <img
                ...
                >
                  <div class="faq-question">
                    <div class="faq-question-text">
                      How does Zenden help with betting?
                    </div>
                    <img
                      src="https://cdn.prod.website-files.com/66a8f0221200d4b2775dabdf/66a8f0221200d4b2775db005_faq-chevron.svg"
                      loading="lazy"
                  ...
                  <div class="faq-answer-wrap">
                    <p class="faq-answer">
                      Zenden offers tools and real-time insights to help users
                      find the most profitable bets and maximize their winnings.
                    </p>
                  </div>
                </div>
                <div
                ...
                >
                  ...
                  <div class="faq-answer-wrap">
                    <p class="faq-answer">
                      No, Zenden does not offer a free plan
                    </p>
                  </div>
                </div>
              </div>
