...
const Ev = () => {
  ...
  useEffect(() => {
    const fetchGames = async () => {
      try {
        const response = fetch("https://bettingscraperodds.onrender.com/data");
              ...
              >
                ...
                <div className="div-block-6">
                  <input
                    ...
                    name="odds"
                    data-name="odds"
                    placeholder={selectedBet ? selectedBet.odd : "0.00"}
                    type="text"
                    id="odds"
                    readOnly
                  />
              ...
              >
                ...
                <div className="div-block-7">
                  <input
                    ...
                    placeholder={
                      selectedBet ? selectedBet.winProbability : "0.00"
                    }
                    type="text"
                    id="winProbability"
                    readOnly
              ...
              >
                ...
                <div className="div-block-7">
                  <input
                    ...
                    placeholder={calculateExpectedValue()}
                    type="text"
                    id="expectedValue"
                    readOnly
                  />
              ...
              >
                ...
                >
                  ...
                  <p className="large-paragraph">
                    {bet.market} - {bet.bookmaker} - {bet.outcome} @ {bet.odd}
                  </p>
