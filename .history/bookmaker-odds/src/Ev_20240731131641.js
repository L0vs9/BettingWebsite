...
const Ev = () => {
  ...
  return (
    <div>
      <header className="navbar-container-2 w-nav">
        <div className="container">
          <div className="navbar-wrapper-2">
            ...
            <nav role="navigation" className="nav-menu-wrapper-1 w-nav-menu">
      ...
      <section className="section-5">
        <div className="scrollable-section">
          {Object.keys(positiveEvBets).map((game, index) => (
            <div key={index} className="licenses-item-3">
              <h3 className="game-title">{game}</h3>
              <div className="bets-scrollable-container">
                {positiveEvBets[game].map((bet, betIndex) => (
                  <ScrollLink
                    key={betIndex}
                    to="calculator"
                    smooth={true}
                  ...
                  >
                    ...
                    >
                      ...
                      <p>
                        Odds: {bet.odd} - Betfair: {bet.betfairOdd}
                      </p>
                      <p>
                        EV: {bet.ev}% - Win Prob: {bet.winProbability}%
                      </p>
                    </div>
                  </ScrollLink>
                ))}
