            ...
            <div className="ev-container">
              ...
              {games.map((game, index) => (
                <Element
                  key={index}
                  name={`game-${index}`}
                  className="game-full-details"
                >
                  <h2>{game.tournamentName}</h2>
                  <h3>
                    {game.home} vs {game.away}
                  </h3>
                  <p>
                  ...
                  <p>Odds:</p>
                  <ul>
                    <li>Home: {game.homeOdds}</li>
                    <li>Draw: {game.drawOdds}</li>
                    <li>Away: {game.awayOdds}</li>
                  </ul>
                  {/* Add any additional game details you want to display */}
                </Element>
              ))}
            </div>
          </div>
