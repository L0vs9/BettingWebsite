...
const Zenden = () => {
  ...
  return (
    <!DOCTYPE html>
<!-- This site was created in Webflow. https://webflow.com --><!-- Last Published: Sat Jul 27 2024 13:38:09 GMT+0000 (Coordinated Universal Time) -->
<html
...
>
  <head>
    ...
    <link
      href="https://cdn.prod.website-files.com/65088655740ea01aaba3bc2a/css/lukas-fantastic-site-2d7cd2.webflow.85cb0273b.css"
      rel="stylesheet"
      type="text/css"
    />
          ...
          <div class="navbar-wrapper">
            ...
            <nav role="navigation" class="nav-menu-wrapper w-nav-menu">
              <ul role="list" class="nav-menu w-list-unstyled">
                ...
                <li><a href="/blog" class="nav-link">FAQs</a></li>
                <li></li>
        ...
        <div class="home-hero-grid">
          ...
          >
            ...
            <h1 class="display-heading-1">
              Bet smarter<span class="text-color-primary-gradient">
                with Zenden</span
              >.
            </h1>
            <p>
