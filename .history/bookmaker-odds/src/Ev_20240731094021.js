    ...
    >
      ...
      <body>
        ...
        <div className="w-layout-blockcontainer container-2 w-container">
          <div id="w-node-_7006779d-c343-ac8e-fc54-9423bdde4876-c1a87a73" className="w-form">
            <form id="email-form" name="email-form" data-name="Email Form" method="post" className="contact-form-2">
              <section className="section-2">
                <div id="w-node-_7006779d-c343-ac8e-fc54-9423bdde4879-c1a87a73" className="div-block-2">
                  <label htmlFor="wager" className="field-label-2">Wager:</label>
                </div>
              ...
              <section id="w-node-_7006779d-c343-ac8e-fc54-9423bdde487e-c1a87a73" className="section-3">
                <div className="div-block-3">
                  <label htmlFor="odds" className="field-label-2"><strong>Odds:</strong></label>
                </div>
              ...
              <section id="w-node-_7006779d-c343-ac8e-fc54-9423bdde4885-c1a87a73" className="section-4">
                <div className="div-block-4">
                  <label htmlFor="winProbability" className="field-label-2"><strong>Win Probability</strong></label>
                </div>
                <div className="div-block-7">
                  <input
                    ...
                    id="winProbability"
                    required=""
                    value={selectedBet ? `${selectedBet.winProbability}%` : ''}
                    readOnly
                  />
                </div>
              </section>
              <section id="w-node-_7006779d-c343-ac8e-fc54-9423bdde488c-c1a87a73" className="section-4">
                <div className="div-block-4">
                  <label htmlFor="expectedValue" className="field-label-2"><strong>Expected Value</strong></label>
                </div>
                <div className="div-block-7">
                  <input
                    className="text-field-2 w-input"
