...
const Ev = () => {
  ...
  const calculateEV = () => {
    const gameData = games.find(
      (game) => game.home + " vs " + game.away === selectedGame
    );
    if (!gameData) return;
              ...
              {games.map((game, index) => (
                ...
                >
                  <div>
                    ...
                    {Object.entries(evResults).length > 0 && (
                      <table>
                        <thead>
                          <tr>
                            <th>Outcome</th>
                        ...
                        <tbody>
                          {Object.entries(evResults).map(([key, result]) => (
                            <tr key={key}>
                              <td>
                                {key === "0"
                                  ? "Home"
